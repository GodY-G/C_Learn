...
**阶段一：[C语言笔试基本功](./Phase1_C_Fundamentals/notes/题目清单.md)（7月 — 15题）**
**阶段二：[408核心算法](./Phase2_408_Core/notes/题目清单.md)（8-9月 — 20题）**
**阶段三：[拔高与408大题特训](./Phase3_Advanced_408/notes/题目清单.md)（10-11月 — 7+3题）**
**阶段四：[12月真题冲刺](./Phase4_Final_Sprint/notes/真题清单.md)（12月）**
...
- now:
    ...
    [PAT_ADVANCED](https://pintia.cn/problem-sets/994805342720868352/exam/problems/type/7)
